...
export const products: Product[] = [
  {
    ...
    category: 'devices',
    images: [
      '/images/radiantwave-pro-1.jpg',
      '/images/radiantwave-pro-2.jpg',
    ],
    rating: 4.9,
    reviewCount: 2847,
    benefits: [
  ...
  },
  {
    ...
    category: 'skincare',
    images: [
      '/images/glowboost-serum-1.jpg',
      '/images/glowboost-serum-2.jpg',
    ],
    rating: 4.8,
    reviewCount: 1923,
    benefits: [
  ...
  },
  {
    ...
    category: 'devices',
    images: [
      '/images/radiantwave-mini-1.jpg',
      '/images/radiantwave-mini-2.jpg',
    ],
    rating: 4.7,
    reviewCount: 642,
    benefits: [
  ...
  },
  {
    ...
    category: 'skincare',
    images: [
      '/images/renew-complex-1.jpg',
      '/images/renew-complex-2.jpg',
    ],
    rating: 4.8,
    reviewCount: 1105,
    benefits: [
  ...
  },
  {
    ...
    category: 'skincare',
    images: [
      '/images/repair-mask-1.jpg',
      '/images/repair-mask-2.jpg',
    ],
    rating: 4.6,
    reviewCount: 534,
    benefits: [
  ...
  },
  {
    ...
    category: 'bundles',
    images: [
      '/images/complete-glow-system-1.jpg',
      '/images/complete-glow-system-2.jpg',
    ],
    rating: 5.0,
    reviewCount: 1248,
    benefits: [
  ...
  },
  {
    ...
    category: 'skincare',
    images: [
      '/images/gentle-cleanser-1.jpg',
      '/images/gentle-cleanser-2.jpg',
    ],
    rating: 4.7,
    reviewCount: 763,
    benefits: [
  ...
  },
  {
    ...
    category: 'skincare',
    images: [
      '/images/spf50-day-shield-1.jpg',
      '/images/spf50-day-shield-2.jpg',
    ],
    rating: 4.8,
    reviewCount: 981,
    benefits: [
