        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="flex justify-center lg:justify-end animate-slide-in-right">
            <div className="relative">
              ...
              <Image
                src="https://placehold.co/700x700/E8D5C8/8B7355?text=RadiantWave+Pro"
                alt="RadiantWave Pro LED Skincare Device"
                width={560}
                height={560}
                priority
                className="relative z-10 rounded-3xl object-cover shadow-warm-xl w-full max-w-[480px] lg:max-w-[560px]"
              />
              {/* Floating stat card */}
